      ...
      try {
        ...
        for (const booking of apiBookings) {
          if (booking.stid && booking.time_visit) {
            ...
            // อัพเดท approve_status และ approve_comment (ใช้ field 'note' จาก API)
            if (existingSurvey) {
              ...
              // API ไม่มี field approve_comment โดยตรง - ใช้ field 'note' แทน
              const approveComment = booking.note || null;
