        ...
        <div v-else class="patients-grid">
          ...
          <div v-for="(visitor, index) in visitors" :key="visitor.id" class="patient-card-row">
            ...
            <div 
              ...
              :class="{
                'visit-ready': visitor.appointmentDate && !visitor.currentSurveyCompleted,
                'visit-disabled': !visitor.appointmentDate || visitor.currentSurveyCompleted
              }"
              @click="visitor.appointmentDate && !visitor.currentSurveyCompleted ? recordVisit(visitor) : null"
              :style="{ cursor: visitor.appointmentDate && !visitor.currentSurveyCompleted ? 'pointer' : 'not-allowed' }"
            >
