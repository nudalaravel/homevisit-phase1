...
export default {
  ...
  data() {
    return {
      ...
      tableData: [
        {
          visitorName: 'น.ส.สุชัยนี สาเร๊ะ',
          paymentDate: 'พ. 01 พฤศจิกายน 2566',
          installment: 11,
          amount: '2000.00',
          idCard: '3940500242204',
          address: '69/16 หมู่ที่ 3 ต.สะบ้าย้อย อ.สะบ้าย้อย จ.สงขลา',
          sendReceipt: true,
          sendIdCard: true,
          isComplete: true
        },
        {
          ...
          paymentDate: 'พ. 04 ตุลาคม 2566',
          installment: 10,
          amount: '3300.00',
          idCard: '3940500242205',
          address: '70/1 หมู่ที่ 4 ต.สะบ้าย้อย อ.สะบ้าย้อย จ.สงขลา',
          sendReceipt: true,
          sendIdCard: true,
          isComplete: true
        },
        {
          ...
          installment: 9,
          amount: '900.00',
          idCard: '3940500242206',
          address: '71/2 หมู่ที่ 5 ต.สะบ้าย้อย อ.สะบ้าย้อย จ.สงขลา',
          sendReceipt: true,
          sendIdCard: true,
          isComplete: true
        },
        {
          ...
          installment: 11,
          amount: '600.00',
          idCard: '3940500242207',
          address: '72/3 หมู่ที่ 6 ต.สะบ้าย้อย อ.สะบ้าย้อย จ.สงขลา',
          sendReceipt: true,
          sendIdCard: true,
          isComplete: true
        },
        {
          ...
          installment: 10,
          amount: '1200.00',
          idCard: '3940500242208',
          address: '73/4 หมู่ที่ 7 ต.สะบ้าย้อย อ.สะบ้าย้อย จ.สงขลา',
          sendReceipt: true,
          sendIdCard: true,
          isComplete: true
        },
        {
          ...
          installment: 10,
          amount: '3700.00',
          idCard: '3940500242209',
          address: '74/5 หมู่ที่ 8 ต.สะบ้าย้อย อ.สะบ้าย้อย จ.สงขลา',
          sendReceipt: true,
          sendIdCard: true,
          isComplete: true
        }
