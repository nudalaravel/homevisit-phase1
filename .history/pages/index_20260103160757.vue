        ...
        <div v-else class="patients-grid">
          ...
          <div v-for="(visitor, index) in visitors" :key="visitor.id" class="patient-card-row">
            ...
            <div 
              ...
              :class="{
                'visit-ready': visitor.appointmentDate && !visitor.currentSurveyCompleted && !visitor.hasSurveyProgress,
                'visit-disabled': !visitor.appointmentDate || visitor.currentSurveyCompleted || visitor.hasSurveyProgress
              }"
            ...
            >
              ...
              <div v-else-if="visitor.currentSurveyCompleted && !visitor.currentSurveySynced" class="visit-text-warning">
                บันทึกเรียบร้อย<br>รอซิงค์
              </div>
              <!-- กรณีกำลังบันทึกอยู่ (มี survey แต่ยัง incomplete) -->
              <div v-else-if="visitor.hasSurveyProgress && !visitor.currentSurveyCompleted" class="visit-text-warning">
...
export default {
  ...
  methods: {
    ...
    canRecordVisitForVisitor(visitor) {
      ...
      // ถ้ามี survey in progress (บันทึกยังไม่เสร็จ) → อนุญาตให้ทำต่อได้
      // (ถ้าต้องการบล็อก ให้ uncomment code ด้านล่าง)
      // if (visitor.hasSurveyProgress && !visitor.currentSurveyCompleted) {
      //   return false
      // }
