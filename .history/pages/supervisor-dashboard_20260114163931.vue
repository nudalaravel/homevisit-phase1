        ...
        <div id="visit-result-pdf-content" class="visit-record-content">
          ...
          <div class="record-section">
            <div class="info-row-single">
              ...
              <span class="info-value">{{ visitResultForm.childName || '-' }}</span>
            </div>
            <div class="info-row-single">
              <span class="info-label">ชื่อ-นามสกุลของผู้เยี่ยมบ้าน:</span>
              <span class="info-value">{{ visitResultForm.visitorName || '-' }}</span>
            </div>
            <div class="info-row-single">
              <span class="info-label">เวลาเริ่มต้นการเยี่ยมบ้าน:</span>
              <span class="info-value">{{ visitResultForm.visitTime || '-' }}</span>
            </div>
            <div class="info-row-single">
              <span class="info-label">วันที่เยี่ยมบ้าน:</span>
              <span class="info-value">{{ visitResultForm.visitDate || '-' }}</span>
              <span class="info-label" style="margin-left: 1rem;">การเยี่ยมบ้านครั้งที่:</span>
              <span class="info-value">{{ visitResultForm.visitNumber || '-' }}</span>
            </div>
          </div>
          ...
          <div class="record-section">
            ...
            <div class="question-item">
              ...
              <div class="answer-text">{{ getQ1Answer(visitResultForm.answers?.q1) }}</div>
            </div>
            <div class="question-item">
              <div class="question-text">2 : เด็กสามารถเข้าร่วมกิจกรรมการเยี่ยมบ้านครั้งนี้ได้หรือไม่</div>
              <div class="answer-text">{{ getQ2Answer(visitResultForm.answers?.q2) }}</div>
            </div>
          </div>
          ...
          <div class="record-section">
            ...
            <div class="question-item">
              ...
              <div class="answer-text">{{ getQ6Answer(visitResultForm.answers?.q6) }}</div>
            </div>
            <div class="question-item">
              <div class="question-text">4 : ในสัปดาห์ที่ผ่านมา ผู้ปกครองร่วมทำกิจกรรมกับเด็กบ่อยแค่ไหน ?</div>
              <div class="answer-text">{{ getQ8Answer(visitResultForm.answers?.q4) }}</div>
            </div>
            <div class="question-item">
          ...
          <div class="record-section">
            <div class="section-title">ทบทวนกิจกรรมการเยี่ยมบ้าน : เดือนที่ {{ visitResultForm.monthAge || '-' }} การเยี่ยมบ้าน {{ visitResultForm.time || '-' }}</div>
          ...
          <div class="record-section">
            ...
            <div class="question-item">
              ...
              <div class="answer-text">{{ visitResultForm.answers?.q7 === 1 ? 'มี' : visitResultForm.answers?.q7 === 3 ? 'ไม่มี' : '-' }}</div>
            </div>
            <div class="question-item">
              <div class="question-text">8 : มีเด็กคนอื่นร่วมทำกิจกรรมไปพร้อมกับเด็กกลุ่มตัวอย่างด้วยหรือไม่ (เด็กอายุไม่เกิน 5 ขวบ)</div>
              <div class="answer-text">{{ visitResultForm.answers?.q8 === 1 ? 'มี' : visitResultForm.answers?.q8 === 3 ? 'ไม่มี' : '-' }}</div>
            </div>
          </div>

          <!-- Current Visit Activities Section (Q9) -->
          <div v-if="visitResultForm.q9Activities && visitResultForm.q9Activities.length > 0" class="record-section">
            <div class="section-title">9 : ให้ผู้เยี่ยมบ้าน สังเกต หรือ ทบทวน กิจกรรมการเยี่ยมบ้านครั้งนี้ โดยขอให้ผู้ปกครองสาธิตการทำกิจกรรมร่วมกับเด็ก</div>
            <table class="activity-table">
              <thead>
                <tr>
                  <th>ชื่อกิจกรรม</th>
          ...
          <!-- Appointment Section -->
          <div v-if="visitResultForm.appointment && (visitResultForm.appointment.date || visitResultForm.appointment.time)" class="record-section">
            <div class="section-title">10 : นัดหมายการเยี่ยมบ้านครั้งต่อไป</div>
            <div class="question-item">
              <div class="question-text">วันที่นัดหมาย:</div>
              <div class="answer-text">{{ visitResultForm.appointment.date || '-' }} เวลา {{ visitResultForm.appointment.time || '-' }} น.</div>
            </div>
          </div>
          ...
          <div class="record-section">
            <div class="question-item">
              ...
              <div class="answer-text">{{ visitResultForm.endTime || '-' }} น.</div>
            </div>
            <div v-if="visitResultForm.note" class="question-item">
              <div class="question-text">บันทึกผู้เยี่ยมบ้าน:</div>
              <div class="answer-text">{{ visitResultForm.note }}</div>
            </div>
          </div>
        </div>
      </div>
